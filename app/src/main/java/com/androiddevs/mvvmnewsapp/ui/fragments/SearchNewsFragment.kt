...
class SearchNewsFragment : Fragment(R.layout.fragment_search_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener { article ->
            ...
            Log.d("SearchNewsFragment", "Article clicked")
        }
            ...
            when(response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        // +2 because: 1. totalResults is not always divisible by QUERY_PAGE_SIZE
                        // 2. to account for the last page
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            // check if not loading and not last page
...
//                rvSearchNews.setPadding(0, 0, 0, 0)
        ...
        override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
            ...
            // check new state for scrolling with abslistview.onscrolllistener.scroll_state_touch_scroll
